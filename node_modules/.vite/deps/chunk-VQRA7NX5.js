    ...
    class TypeScriptParser extends Parser {
      ...
      typeCastToParameter(node) {
        ...
        this.resetEndLocation(
          ...
          (_a = node.typeAnnotation.loc) == null ? void 0 : _a.end
        );
      ...
      reportReservedArrowTypeParam(node) {
        var _a;
        if (node.params.length === 1 && !((_a = node.extra) == null ? void 0 : _a.trailingComma) && disallowAmbiguousJSXLike) {
      ...
      parseMaybeAssign(forInit, refExpressionErrors, afterLeftParse) {
        ...
        throw (jsx == null ? void 0 : jsx.error) || arrow.error || (typeCast == null ? void 0 : typeCast.error);
      }
...
//# sourceMappingURL=chunk-VQRA7NX5.js.map
